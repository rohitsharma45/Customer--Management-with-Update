...
*/
	...
	public String updateSubmission(@RequestParam("custId") String custNo,Model m){
	System.out.println(custNo);	
	CustomerBean bean=customerService.displayById(custNo);
		m.addAttribute("customer",bean);
		return "updateForm";
		
	}
	
	@RequestMapping(value="/doUpdate")
	public ModelAndView doUpdate(@ModelAttribute("customer") @Valid CustomerBean cust,BindingResult br){
		...
		if(br.hasErrors())
		{
			...
			CustomerBean bean = customerService.update(cust);
			return new ModelAndView("displayById","d",bean);
		}
